...
4. Get average by dividing sum by 2
...
4. Average gets the quotient of the sum divided by 2
5. Print the value of Ave
6. If (Ave modulo 2 is equal to 0)
...
1. Logical Negation 
SYMBOL: ! ; ASSOCIATIVITY: Right -> Left
2. Logical AND
SYMBOL: && ; ASSOCIATIVITY: Left -> Right
3. Logical OR
SYMBOL: || ; ASSOCIATIVITY: Left -> Right

Both sides of && MUST BE TRUE ;  if one is false, the end result is FALSE.
...
If (condition)
  Then Statement
  Statement after If-Then

Events that occur:
a. The condition is evaluated.
b. If condition evaluates as false, the If-Then statement ends and execution passes to the 1st statement AFTER then statement.
c. If true, statement/s UNDER If-Then will be executed.
