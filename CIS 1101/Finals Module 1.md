...
Analogy: Using a 3rd glass to transfer liquids between 2 glasses
...
int main(){
    ...
    printf("%d", *ptr);
    printf("\n%p", &ptr);
    // Use ampersand for address, asterisk for value
    printf("\n%p", x);
    printf("\n%p", &x);
...
# EXECUTION STACK
- data structure in computer science that stores information about the active functions 
(or subroutines) of a running computer program
